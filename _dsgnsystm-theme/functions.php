		...
		add_theme_support(
			...
			array(
				array(
					...
					'slug'  => 'primary',
					'color' => _dsgnsystm_hsl_hex( 'default' === get_theme_mod( 'primary_color' ) ? $default_hue : get_theme_mod( 'primary_color_hue', $default_hue ), $saturation, $lightness ),
				),
				array(
					'name'  => __( 'Secondary', '_dsgnsystm' ),
					'slug'  => 'secondary',
					'color' => _dsgnsystm_hsl_hex( 'default' === get_theme_mod( 'primary_color' ) ? $default_hue : get_theme_mod( 'primary_color_hue', $default_hue ), $saturation, $lightness_hover ),
				),
				array(
 ...
 */
function _dsgnsystm_editor_theme_variables() {
	/* Add Global variables */
	wp_enqueue_style( '_dsgnsystm-editor-variables', get_template_directory_uri() . '/style-editor-variables.css', array(), wp_get_theme()->get( 'Version' ) );
}
add_action( 'enqueue_block_editor_assets', '_dsgnsystm_editor_theme_variables' );
