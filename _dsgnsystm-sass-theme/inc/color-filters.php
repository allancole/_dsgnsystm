 ...
 */
function _dsgnsystm_sass_get_default_hue() {
	return apply_filters( '_dsgnsystm_sass_default_hue', _DSGNSYSTM_DEFAULT_HUE );
}
 ...
 */
function _dsgnsystm_sass_get_default_saturation() {
	return apply_filters( '_dsgnsystm_sass_default_saturation', _DSGNSYSTM_DEFAULT_SATURATION );
}
 ...
 */
function _dsgnsystm_sass_get_default_lightness() {
	return apply_filters( '_dsgnsystm_sass_default_lightness', _DSGNSYSTM_DEFAULT_LIGHTNESS );
}
 ...
 */
function _dsgnsystm_sass_get_default_saturation_selection() {
	return apply_filters( '_dsgnsystm_sass_default_saturation_selection', _DSGNSYSTM_DEFAULT_SATURATION_SELECTION );
}
 ...
 */
function _dsgnsystm_sass_get_default_lightness_selection() {
	return apply_filters( '_dsgnsystm_sass_default_lightness_selection', _DSGNSYSTM_DEFAULT_LIGHTNESS_SELECTION );
}
 ...
 */
function _dsgnsystm_sass_get_default_lightness_hover() {
	return apply_filters( '_dsgnsystm_sass_default_lightness_hover', _DSGNSYSTM_DEFAULT_LIGHTNESS_HOVER );
}

function _dsgnsystm_sass_has_custom_default_hue() {
	return _dsgnsystm_sass_get_default_hue() !== _DSGNSYSTM_DEFAULT_HUE;
}
