 ...
 */
function _dsgnsystm_sass_custom_colors_css() {
	 ...
	 */
	$saturation_selection = _dsgnsystm_sass_get_default_saturation_selection();
	 ...
	 */
	$lightness_selection = _dsgnsystm_sass_get_default_lightness_selection();
	 ...
	 */
	return apply_filters( '_dsgnsystm_sass_custom_colors_css', $theme_css, $primary_color, $saturation );
}
